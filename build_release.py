...
wrap_dir = "copy_to_asset_library"  # Wrap the output in a directory in the ZIP file
output_file = f"copy_to_asset_library_{tag_name}.zip"  # What to call the ZIP file
